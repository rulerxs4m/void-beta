...
def datewise_plotter(dates: list[datetime.date], values: list[int], *, max_xticks: int = 15, filename: str = "plot.png"):
    ...
    # Plot stairs
    plt.stairs(values, edges=np.arange(len(values) + 1), color="white", linewidth=3)
    # plt.plot(x, y, "o", color="white", markerfacecolor="white", markeredgecolor="white")  # Optional: add points
